...
if __name__ == '__main__':
   ...
   #  """
   #  v=eval(input())
   #  output = [j-i for i,j in zip(v[:-1], v[1:])] # Put your line here (my solution: 23 chars)
   #  print(output)
   ...
   #  output = [i for i, val in enumerate(v) if val==n] # Put your line here (my solution: 37 chars)
   #  print(output)
   ...
   #  """
   #  v,n = [f(x) for f,x in zip((eval,int),input().split())]
   #  output = "".join(['=' if val==n else '!' for val in v]) # Put your line here (my solution: 42 chars)
   #  print(output)
   ...
   #  print(output)
    ...
    output = round(sqrt(sum(float((ui-vi)**2) for ui,vi in zip(u,v)))) # Put your line here (my solution: 40 chars)
    print(output)
    ...
    """
    m=eval(input())
    output = [obj for lst in m for obj in lst] # Put your line here (my solution: 9 chars)
    print(output)
